...
import {
  ...
  type Matcher,
} from "@/pages/_components/ui/calendar";
import { LucideCalendar, LucideMinus } from "lucide-react";
    ...
    return (
      <PopoverPrimitives.Trigger asChild>
        <button
          ...
          {...props}
        >
          <LucideCalendar className="size-5 shrink-0 text-gray-400 dark:text-gray-600" />
            ...
            <div className="overflow-x-auto">
              ...
              {showTimePicker && (
                <div className="flex items-center justify-evenly gap-x-3 border-t border-gray-200 p-3 dark:border-gray-800">
                  ...
                  <LucideMinus className="size-4 shrink-0 text-gray-400" />
                  <div className="flex flex-1 items-center gap-x-2">
                    <span className="dark:text-gray-30 text-gray-700">
